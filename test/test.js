var chai = require('chai')
  ...
  , should = chai.should()
  , Machine = require('../src/index').Machine

chai.use(spies);

describe('Fede State Machine', function() {

  it('Create a Machine with no initial state', function() {
    var m = new Machine({ start: {} });
    should.not.exist(m.state);
  });

  it('Create a Machine that transits to the initial state', function() {
  ...
  it('Create a Machine that transits to the initial state and calls the entry function', function() {
  ...
  it('Transit to a known state', function() {
    var m = new Machine({
      start: {}
    });
    should.not.exist(m.state);
  ...
  it('Transit to an unknown state', function() {
    var m = new Machine({
      start: {}
    });
    should.not.exist(m.state);
  ...
  it('Perform a valid transition', function() {
    var m = new Machine({
      start: {
        transitions: [ 'end' ]
      },
  ...
  it('Perform an invalid transition', function() {
    var m = new Machine({
      start: {
        transitions: [ 'end' ]
      },
  ...
  it('Perform a valid transition calling exit and entry functions', function() {
  ...
  it('Create a default event handler', function() {
    var m = new Machine({
      start: {
        transitions: [ 'end' ]
      },
  ...
  it('Create an event handler whose state handlers are called according to the fsm state', function() {
    var m = new Machine({
      start: {
